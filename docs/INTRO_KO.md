...
[EXPERIMENT_PAGE_TEMPLATE_KO.md](EXPERIMENT_PAGE_TEMPLATE_KO.md) 파일에 Confluence 페이지 한국어 템플릿이 있습니다. 팀 실험 관리 전체 규칙은 [EXPERIMENT_STANDARD_KO.md](EXPERIMENT_STANDARD_KO.md)를 참조하세요.
