...
| 🖥️ Operator — air-gapped GPU node bring-up | [`21_AIRGAPPED_GPU_SERVER_SETUP.md`](21_AIRGAPPED_GPU_SERVER_SETUP.md) (Step 1 transfer & install via Method A or B, Step 2 smoke-test verification) |
| ⚡ Anyone exploring opt-in features | [`30_ADVANCED_FEATURES.md`](30_ADVANCED_FEATURES.md), [`31_CHART_SETTINGS.md`](31_CHART_SETTINGS.md) |
