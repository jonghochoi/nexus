...
- **New Pipeline B CLI flag** — `post_upload/tb_to_mlflow.py::parse_args()`, plus the flag table in `README.md` "Pipeline B" section and the deeper notes in `docs/13_POST_UPLOAD.md`.
